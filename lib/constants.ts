...
export const resumeLink =
  "https://drive.google.com/file/d/1iAVRTIRq8MVM2Fj2yal5Q9j7M-jlyUld/view?usp=sharing";
...
export const profileLinks = [
  ...
  {
    icon: StickyNote,
    link: "https://drive.google.com/file/d/1iAVRTIRq8MVM2Fj2yal5Q9j7M-jlyUld/view?usp=sharing",
    title: "CV/Resume",
  },
  {
    icon: BsLinkedin,
...
export const projects = [
  ...
  },
  {
    title: "PrintNext",
    description:
      "A High performance Saas app for making customisable collages, passport photos, cropping pdfs, aadhar, ayushman and printing the same",
    tech: [
      "Typescript",
      "Next Js",
      "TailwindCSS",
  ...
  },
  {
    ...
    tech: ["Typescript", "Nextjs", "ChatGPT-api", "TailwindCSS", "ShadcnUI"],
